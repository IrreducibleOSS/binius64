...
cfg_if! {
	if #[cfg(all(target_arch = "x86_64"))] {
		...
		pub use portable::{packed_128, packed_256, packed_512, packed_aes_128, packed_aes_256, packed_aes_512, packed_polyval_128, packed_polyval_256, packed_polyval_512, packed_ghash_512};
	} else {
		mod portable;
