...
/// [N..N + N/2): Level 1 products (pairs of adjacent elements)
/// [N + N/2..N + N/2 + N/4): Level 2 products (pairs from level 1)
/// ...
/// [2*N-2): Root product (single element - product of all inputs)
/// ```
#[inline]
...
// #[inline]
// fn batch_invert_3x_power_of_2<const N: usize>(elements: &mut [Ghash], scratchpad: &mut [Ghash]) {
// 	let group_size = N / 3;
