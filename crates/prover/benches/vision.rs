...
use binius_prover::hash::{
	...
	vision_4::{
		...
		vision::VisionHasherMultiDigest as VisionHasherMultiDigest_4,
	},
	vision_6::{
		parallel::parallel_permutation as parallel_permutation_6,
		vision::VisionHasherMultiDigest as VisionHasherMultiDigest_6,
	},
};
...
criterion_main!(hash_vision_bench);
