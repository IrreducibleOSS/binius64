...
// Also implement PseudoCompressionFunction to maintain compatibility with verifier code
impl<T, C, const N: usize> PseudoCompressionFunction<T, N> for ParallelCompressionAdaptor<C>
where
	C: PseudoCompressionFunction<T, N>,
{
