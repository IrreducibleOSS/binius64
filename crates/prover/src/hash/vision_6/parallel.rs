...
fn parallel_batch_invert<const N: usize, const MN: usize, const MN_DIV_3: usize>(
	...
	// // M=6 is not a power of 2, so split each state into 3 pairs of size 2
	// // Each batch_invert::<2> needs 3 scratchpad elements
	// let mut scratchpad_offset = 0;

	// for i in 0..N {
	// 	let state_start = i * M;

	// 	// Invert pairs within each state
	// 	batch_invert::<2>(
	// 		&mut states[state_start..state_start + 2],
	// 		&mut scratchpad[scratchpad_offset..scratchpad_offset + 3],
	// 	);
	// 	scratchpad_offset += 3;

	// 	batch_invert::<2>(
	// 		&mut states[state_start + 2..state_start + 4],
	// 		&mut scratchpad[scratchpad_offset..scratchpad_offset + 3],
	// 	);
	// 	scratchpad_offset += 3;

	// 	batch_invert::<2>(
	// 		&mut states[state_start + 4..state_start + 6],
	// 		&mut scratchpad[scratchpad_offset..scratchpad_offset + 3],
	// 	);
	// 	scratchpad_offset += 3;
	// }
