use crate::protocols::sumcheck::and_reduction::univariate::delta::delta_poly;
...
use crate::protocols::sumcheck::and_reduction::fold_lookups::precompute_fold_lookup;
use crate::protocols::sumcheck::and_reduction::sumcheck_prover::{multilinear_sumcheck, AndReductionMultilinearSumcheckProver, FoldDirection};
use crate::protocols::sumcheck::and_reduction::one_bit_multivariate::OneBitMultivariate;
...
use crate::protocols::sumcheck::and_reduction::sumcheck_round_message::sum_claim;
use crate::protocols::sumcheck::and_reduction::sumcheck_round_message::univariate_round_message;
...
fn test_do_claims_match(fold_direction: FoldDirection) {
    ...
    let folded_first_mle: FieldBuffer<BinaryField128bPolyval> = first_mlv.fold(&fold_lookup_polyval);
    let folded_second_mle: FieldBuffer<BinaryField128bPolyval> = second_mlv.fold(&fold_lookup_polyval);
    let folded_third_mle: FieldBuffer<BinaryField128bPolyval> = third_mlv.fold(&fold_lookup_polyval);
