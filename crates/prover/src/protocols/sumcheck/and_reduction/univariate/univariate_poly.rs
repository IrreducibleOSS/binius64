...
impl UnivariatePoly<AESTowerField8b, BinaryField128bPolyval> for GenericPo2UnivariatePoly<'_, AESTowerField8b, BinaryField128bPolyval> {
...
impl<F: Field> UnivariatePoly<F, F>
    for GenericPo2UnivariatePoly<'_, F, F>
{
