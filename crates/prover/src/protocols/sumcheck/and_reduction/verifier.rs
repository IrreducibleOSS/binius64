...
// use crate::{utils::{constants::{ROWS_PER_HYPERCUBE_VERTEX, SKIPPED_VARS}, subfield_isomorphism_lookup::SubfieldIsomorphismLookup}, univariate::{delta::delta_poly, univariate_poly::{UnivariatePoly, GenericPo2UnivariatePoly}}, multilinear_sumcheck::multilinear_sumcheck::verify_round};

use crate::protocols::sumcheck::and_reduction::{fold_lookups::precompute_fold_lookup, one_bit_multivariate::OneBitMultivariate, sumcheck_prover::verify_round, sumcheck_round_message::sum_claim, univariate::{delta::delta_poly, ntt_lookup::{precompute_lookup, ROWS_PER_HYPERCUBE_VERTEX, SKIPPED_VARS}, subfield_isomorphism::SubfieldIsomorphismLookup, univariate_poly::UnivariatePoly}};
...
impl OblongZerocheckVerifier {
        ...
        FIntermediateForLookup: Field+ From<AESTowerField8b>
    {
        ...
        for (i,this_round_zerocheck_challenge) in multilinear_zerocheck_challenges.iter().enumerate(){
